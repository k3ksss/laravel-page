...
@section('content')
    ...
    <input type="text" id="adrese" placeholder="Adrese"/>
    ...
    <script>
        ...
        function JanaNumurs(item){
            document.getElementById("tabula").innerHTML+= "<tr>"
                ...
                +"<td>"+ item.adrese + "</td>"
                +"<td>"+ "<a href=\"http://inventars.local/tabulas/filiales/edit/" + item.id + "\"><button class=\"btn btn-warning\">Rediģēt</button></a>" + "</td>"
        ...
        function deleteFunction(idIN) {
            ...
            $.ajax({
                type: "POST",
                url: "http://inventars.local/tabulas/filiales/delete",
                data: {
                    id: idIN
                },
        ...
        $(document).ready(function(){
            ...
            $("#pievinot").click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "http://inventars.local/tabulas/filiales",
                    data: {
                        id:$('#id').val(),
                        filiales_nosaukums:$('#fliale').val(),
                        adrese:$('#adrese').val(),
